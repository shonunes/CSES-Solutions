...
{
    return __query_tree(1, 1, seg_tree.size() / 2, query);
}

void update_tree(ll range_start, ll range_end, ll val)
{
    __update_tree(1, 1, seg_tree.size() / 2, range_start, range_end, val);
}
